...
import com.ayokunlepaul.erewarder.di.modules.presentation.ERewarderFragmentBinding
import com.ayokunlepaul.erewarder.di.modules.repository.RepositoryModule
...
@Component(
    modules = [
        ...
        ERewarderFragmentBinding::class,
        DomainModule::class,
        CacheModule::class,
